...
def analyze(raw_report, edited_report):
    ...
    dt_avg_group_len = results_edited["avg_group_len"] - results_raw["avg_group_len"]
    dt_group_rate = results_edited["group_rate"] - results_raw["group_rate"]

    pcnt_1 = (dt_total_num_defects / results_edited["total_defects"]) * 100
    pcnt_2 = (dt_total_num_groups /results_edited["total_groups"]) * 100
    pcnt_3 = (dt_avg_defects / results_edited["avg_defects_per_lot"]) * 100
    pcnt_4 = (dt_avg_groups / results_edited["avg_groups_per_lot"]) * 100
    pcnt_5 = (dt_avg_group_len / results_edited["avg_group_len"]) * 100
    pcnt_6 = (dt_group_rate / results_edited["group_rate"]) * 100
...
"""
    ...
    os.makedirs("reports/metadata/", exists_ok=True)
